...
./ip -netns encap route add db02::/64 encap ioam6 dex ns 123 trace-type 0XF6E000 ext-flags 0xC0 via db01::2 dev veth0
...
ip -netns encap ioam schema add 1 deadbeef
ip -netns encap ioam namespace set 123 schema 1
...
ip -netns transit ioam schema add 1 deadbeef
ip -netns transit ioam namespace set 123 schema 1
...
ip -netns decap ioam schema add 1 deadbeef
ip -netns decap ioam namespace set 123 schema 1
